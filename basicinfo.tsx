...
const yourName : String = "Suhas Bolledula";
let yourPronouns : String = "He/Him/His";
const yourMajor : String = "Computer Science";
let classification : String = "junior";
let oneExcite : String = "Learning and creating web development";
let anyConcerns : String = "Managing my time with the tasks and projects";
let funFact : String = "I ride a motorcycle";
*/
